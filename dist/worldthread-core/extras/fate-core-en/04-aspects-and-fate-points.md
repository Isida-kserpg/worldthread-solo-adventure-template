...
GMs and players, you both have a pool of points called fate points you can use to influence the
...
action, and we say that you managed to get me A Little Off-
Balance. On your next action, you follow-up by saying that you want to
...
A Little Off-Balance with two free invocations (or three
...
you could still create the A Little Off-Balance advantage,
...
boost (including invoking it against its owner). Any other rules that require an
...
might have a high Fight skill, but only
Landon is a Disciple of the Ivory Shroud. When his path as
...
people will do Anything for Survival, and where
The Empire is Everywhere, they don’t really have anything
...
you add the aspect Huge Bronze Devil Statue to the scene,
...
situation aspects tell you that the ladder is a Rotting Rope
Ladder and the idol is Protected by the Wrath of the
Gods, then you suddenly have an element of pressure and risk that makes
...
> Let’s look at an aspect like Computer Genius. The
...
Earlier, it was noted several things that a character aspect might describe: personality traits,
...
Just a Simple Farmboy isn’t quite as fetching as
Child of Pastoral Bliss. If that’s the tone your game is
...
> Let’s look at Memories, Wishes, and Regrets. There’s
...
> I think this is all fantastic, and I suggest we call it Scars
from the War. Less poetic, maybe, but it directly references all the
...
> During Cynere’s phase three, Lily
...
I’ve Got Zird’s Back, because it’s specific enough to be
...
> Lenny ends up with Disciple of the Ivory Shroud and
The Manners of a Goat as Landon’s high concept and
...
> Lenny does his phase one and explains
...
I Owe Old Finn Everything, and Amanda now has a new NPC to
play with.
...
invoke The Manners of a Goat.” Amanda gives him a
...
be a quick feint-and-slash, a classic move from the Infamous Girl
with Sword” (spends the fate point).

Ryan says, “So I’m trying to decipher the runes in the book and...” (rolls the
dice, hates the result) “...and If I Haven’t Been There, I’ve
Read About It...” (spends a fate point) “...and I easily start rambling
about their origin.”
...
When you succeed at creating an advantage, you “stick” a free invocation onto an
...
Cut Across the Gut consequence. On the next exchange, she
...
On Fire even if one character deliberately created it as
...
> Cynere has Infamous Girl with Sword while covertly
...
> Landon has I Owe Old Finn Everything and is returning to
...
> Zird has Rivals in the Collegia Arcana and is attempting
...
> Landon has The Manners of a Goat while trying to impress
...
> Cynere has Tempted by Shiny Things while touring an
...
> Zird has Not the Face! when he gets challenged to a
...
> Because the warehouse is On Fire, and the player
...
> The manor house Cynere is searching through is Littered with
Debris, so it makes sense that, unfortunately, the city guard is going
...
Strongest Man in the World? That’s a reputation that might
...
> Lenny looks at some of the aspects on Landon’s sheet: Disciple
of the Ivory Shroud, I Owe Old Finn Everything,
The Manners of a Goat, and Smashing is Always
an Option. His read of those aspects is that they show Landon as being
...
no sense if you succeed. (For example, if you’re Grappled,
you could try to sprint away. If you succeed, it wouldn’t make sense for you
to be Grappled anymore, so you’d also get rid of that
aspect.)
...
For the most part, you’ll use the create an advantage action to make new aspects. When you
...
don’t exactly want the culprit to have Sociopathic Serial
Murderer sitting on an index card for the PCs to see at the beginning
of the adventure.
...
> Instead of making a Secretly a Vampire aspect, she
decides to make a few personal details instead: Inveterate Night
Owl, Tougher Than He Looks, and Wheels
...
is discussed in The Long Game), which you can spend on getting more stunts or keep in order to
