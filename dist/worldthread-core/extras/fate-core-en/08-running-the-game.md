...
The GM’s job was discussed a bit in The Basics, but let’s take a more detailed look at your unique
responsibilities.
...
to. So if someone has Scars from the Great War, poll that
...
Also, one of the main uses of the create an advantage action is precisely to give players a way to add details to
...
during play, like we talked about in the Aspects and Fate Points section, and
...
There’s already been some discussion of game scale in Game Creation, but it’s worth a
...
The most common example of this has to do with consequences. The rules say that
...
It’s totally fine to assign a mild consequence of Glass in My
Hand in that case, because it fits with the narration, even though
...
**A minor cost should complicate the PC’s life.** Like the above suggestion, this focuses on using failure as a means to change up the situation a bit, rather than just negating whatever the PC wanted. Some suggestions:
  ...
  * Place an aspect on the PC or the scene. _“Somehow you manage to land on your feet, but with a _Twisted Ankle_ as a souvenir.”_
...
pressure, such as challenges or
contests—they each limit the number of
...
(“Hey, I’m a Garage Bunny, so fixing this car shouldn’t
take me that long, right?” “Oh, you know what? Your sheet says I
Can’t Get Enough of the Fun and Games… doesn’t it make sense that if
...
Former Ivory Shroud Disciple, as a result of discovering a
...
suggests that they want to bring Landon back into the fold rather
than hurt or kill him, so Lenny decides to take I Don’t Know What’s Right
Anymore, reflecting the seeds of doubt they’re planting in his mind.
...
I Know Your Name, which you might use to undermine her
confidence.”
...
stunt use—the individual descriptions in Skills and Stunts, the action descriptions and examples in
Challenges, Contests, and Conflicts, and the advice immediately above about setting
...
Looking over the skill descriptions, you might notice that there are a few places where you
...
on a specific target. A Gas-Filled Room has the potential
to affect everyone in it, and it’s not too much of a stretch to suggest that
the Inspirational Mood in a room could be contagious. In
...
This Guy is Bigger Than I Thought....
...
with that in the Extras section, but let’s
...
an Athletics contest. If it makes sense
...
As with skills and stunts, the entire Aspects and Fate Points section is designed
...
decision-based, where something complicated occurs as a
...
you have The Manners of a Goat. Lenny, do you think this
...
“So, you know that Duke Orsin is Woefully
Overconfident....You think he’s going to get out of the jousting
...
Actions and Outcomes, and assume that the PC gets past on a successful roll.
...
terms. The faces that you assign to the locations you make during game creation are supporting
...
Skills for a supporting NPC should follow a column distribution. Because you’re
