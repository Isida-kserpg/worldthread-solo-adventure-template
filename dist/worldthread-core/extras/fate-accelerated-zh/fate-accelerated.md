---
source: 命運快速版（Fate Accelerated Edition 繁體中文翻譯），取自 faterpg 翻譯站 https://sites.google.com/site/faterpg/
...
# 命運快速版（Fate Accelerated Edition）

## 命運快速版

## 開始吧！

記得那些青年巫師與黑暗惡魔領主搏鬥的故事嗎？記得那些矮人從龍手中為收復山中家國而戰的電影？記得神秘騎士與他們的克隆軍團穿越銀河以執行正義的動畫節目？

那些是不是超棒的？

這是你能讓自己踏上那些英雄故事的機會。

FATE 快速版是一個桌上角色扮演遊戲，你和朋友聚在一起，敘說充滿危機、刺激與冒險的故事。你可能玩過類似的遊戲——最有名的就是龍與地下城——沒有也不用擔心；這網站會導引你了解這些。

你需要這些來遊玩：

- 三到五個人。你們一個會是遊戲主持人（GM），其他的是玩家。
- 命運骰™，至少四個，每個人四個更好。這是一個特殊骰面的六面骰，兩面是 [+] ，兩面是 [-] ，而兩面是 [0] 。在一些桌遊店或遊戲店，這些骰子通常會用它們原本的名字——胡扯骰（Fudge dice）。他們在這網站叫作命運骰，但是你要叫什麼都可以。
`如果你不想用胡扯骰，你不一定要用——一組普通六面骰也可以。如果你使用普通骰子，你將 5 或 6 讀成 [+] ，1 或 2 讀成 [-] ，3 或 4 讀成 [0] 。`

`命運牌組是命運骰的一個替代方案。這個牌組按照了命運骰的機率，和命運骰的用法相同。你也可以用 app 。`

- 角色表，一個玩家一張。你可以在 www.evilhat.com 載到，或者使用我們製作的中文版。
- 索引卡或便利貼，或類似的紙條。
- 命運點指示物。可以是紙片、玻璃珠、或類似的東西。拿一把——大概 30 或 40 。
接著，我們來談談如何使用命運快速版來說故事。
...
Major milestone重大的里程碑

Mild consequence溫和後果

Milestones里程碑

Minor milestone次要的里程碑

Mobs嘍囉

Moderate consequence中等後果
...
Severe consequence嚴重後果

Shifts檔次

Significant milestone顯著的里程碑
...
一、描述你想讓你的角色做什麼。看是否有人或事物能阻止你。

二、選擇你採取的行動：創造優勢、克服、攻擊或是防禦。
...
- 命運骰，至少四顆，而最好是每個人都有四顆。這是種特殊的六面骰子，兩面標有加號〈＋〉，兩面標有減號〈－〉，還有兩面則是空白。你可以在國外遊戲店找到這種骰子，通常會以它原來的名字標示：胡扯骰，但在台灣的遊戲店並沒有販賣這種骰子，請直接向國外網站訂購。在這裡它被稱為命運骰，但你愛怎麼叫隨你高興。邪惡帽出版社現在在網站上也有販售命運骰。
        - 骰子替代方案
            - 如果你不想使用命運骰也沒關係，任何六面骰都能使用。如果你使用一般骰子，將五與六視為加號，一與二視為減號，三與四視為空白。
