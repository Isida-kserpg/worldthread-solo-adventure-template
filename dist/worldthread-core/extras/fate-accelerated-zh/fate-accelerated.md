...
> 來源：Fate Accelerated Edition 繁體中文翻譯，逐字取自同好翻譯站 https://sites.google.com/site/faterpg/ 。授權與標示見同目錄 `README.md` 及發行包根目錄 `THIRD-PARTY-NOTICES.md`；以原文為準。
...
**開始首次交手。**
**在你的回合，採取行動。**
**在別人的回合，需要時防禦對抗獲回應他們的行動。**
**每個人的回合都結束後，開始新一輪的交手或是結束衝突。**
**設置場景**
...
下面是你該如何創造他們的數據：
製作爪牙擅長什麼的列表。他們在處理這些事情的擲骰上獲得＋２。
製作爪牙不擅長什麼的列表，他們在處理這些事情上的擲骰得到－２。
剩下其他的在擲骰時都獲得＋０。
給爪牙一或兩個能強化他們所擅長和不擅長的形象或是一個特別的力量或弱點的形象。嘍囉的形象就算是非常簡單的也沒關係。
爪牙的壓力軌跡中會有零個、一個或是兩個壓力格，這取決於你認為他們有多強壯。
爪牙不能承受後果來吸收壓力，他們的壓力格用完後〈或是本來就沒有〉，再受到打擊就被剔除。
`獨眼巨人家族土霸`
`獨眼巨人家族土霸，膽小者沒靠山`
...
選擇一些他們擅長的事情。你可能會指定「成群結黨」為群體擅長的事之一。
選擇幾件他們不擅長的事情。
給他們一個形象。
群體內每有兩個個體就給他們一格壓力格。
`幫派份子`
