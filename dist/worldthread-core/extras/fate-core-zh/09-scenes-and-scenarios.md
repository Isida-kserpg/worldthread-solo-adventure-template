---
source: 命運核心版（Fate Core System 繁體中文翻譯）第 9 章〈場景、聚會與劇折〉，取自 faterpg 翻譯站 https://sites.google.com/site/faterpg/
...
到現在為止，你和你的團隊已經創建了玩家角色，建立了他們所居住的世界，為你們要玩的遊戲設定好所有基本假設。現在你有一堆形象和非玩家角色，充滿了戲劇性的潛力並等候著進入生活。

你該對他們做些什麼呢？

現在是時候進入遊戲的實際內容：創造並遊玩整個劇折。

## 定義劇折

定義劇折

正如運行遊戲章節中提到的，劇折是一種遊戲時間單位通常持續一到四次遊戲聚會，並由一些離散的場景所組成。一個劇情段落的結尾應該引發顯著的里程碑，讓你的玩家角色在他們所做的事情上能做得更好。

在一個劇折中，玩家角色將要面對並努力解決一些龐大又緊迫的開放式問題（或多個問題）。遊戲主持人通常會以向玩家呈現出這個問題來展開劇折，隨後的場景圍繞著玩家角色為了處理問題而做得事，不管是研究信息，收集資源，或者直接打擊問題的源頭。

一路上，你還會有一些非玩家角色是對抗者試圖干擾玩家角色試圖解決問題時想達成的目標。這可能是你的雷蒙錢德勒式的「兩個有槍的傢伙」射穿門殺死他們，或者是有著不同的利益的人願意為此與玩家角色進行談判，讓他們以不同方式來處理問題。

最好的劇折不會有一個特定的「正確」結局。也許玩家角色不解決問題，或者以有不好的影響的方式解決它。也許他們出色成功。也許它們繞過這個問題，或者改變局勢盡量減少這一問題的影響。除非開始玩否則你不會知道。

一旦問題解決（或者不再能被解決），該劇折已經結束。接下來的聚會，你們就會開始一個新的劇折，可以是與前個劇折有直接關聯會是展現一個全新的問題。
...
創造劇折由尋找給玩家角色們處理的困境開始。一個好的困境要跟玩家角色有關聯，沒有他們的參與就無法解決，並且忽略會帶來嚴重後果。

這似乎是一個艱鉅的任務。幸運的是，你有個很棒的敘事工具來幫助你找出適合你遊戲的困境：形象。

你的玩家角色的形象有著很多的故事去建構它們，它們象徵著某些對於每個角色最重要的事物，它們象徵著玩家角色在遊戲世界中相關聯的事物，它們也描述出每個角色的身份的獨特之處。

你還有連接到你的遊戲上的形象，所有當前與即將出現的議題、地點形象以及任何你放在你的戰役活動中的人物上的形象。 運用那些有助於加強世界一致與動態的感覺，並讓你的遊戲的核心前提在遊玩中展露出來。

因為這些形象，你已經有大量的潛在故事在你前面，現在你只需要解放它。

你可以把一個與形象相關的困境看作一個非常大規模類型的事件強迫。設定起來是要更多一點的工作，但結構類似，都具有暗示的形象或隱含對單一或多個玩家角色會造成困境的東西，但與強迫不同的是這件事情他們絕不可能輕易地解決或應對。

你不必每次都毀滅世界

正如你會在例子裡看到的，並不是所有緊急、重大的困境都涉及到世界的命運或是設定中的重大部分。人際問題對給玩家們的衝擊可與阻止本週壞人一樣多，無論你的壞人在做什麼盛大計劃，贏得某人的尊重或解決兩個角色之間的持續爭議可以輕鬆地為劇折取得焦點。

如果你想要一個經典的動作冒險故事設置，看看你是否可以為你的劇折提出兩個主要困境：一個專注於角色外部的東西（如惡棍的計劃），而另一個則是處理人際問題。後者將會在你的劇折中充當一個支線插曲，並在他們處理其他困境的過程中給予角色發展時間。

困境和角色形象

當你試圖從一個角色形象獲取困境，試試為下面這句話填空：

- 你有「」形象，這意味著「」（順便說一下，這可能是一長串的事情）。正因為如此，「」很可能是你的一個大困境。
第二空格就是使它比事件強迫再難一點的原因，你必須考慮一個形象所有的不同潛在影響。這裡有一些問題能幫助你去作到這一點。
...
只要你放在本小節一開始的第三空格中可以符合準則，就可以順利完成。

Put a Face on It

儘管並不是所有的劇折困境都必須直接由擔任大壞蛋的非玩家角色引起來讓玩家們解決，但如果是這樣的話，這往往會更容易。至少，你應該能夠直接指向一個從劇折困境中獲益很多的非玩家角色，而不是順著玩家想要的方向。
...
你從遊戲當前和即將出現的議題中所得的困境在範圍上會比驅使角色的困境要來得寬些，影響你所有的玩家角色以及顯著數量的非玩家角色。他們很少是個人的事，但這並不意味著他們很少用來強迫（請原諒這個雙關語）。
...
這裡才是你真正開始料理的地方。你還可以從兩個形象之間的關係來創造困境，而不只是依賴單一個。這可以讓你保持事情的私人性，又能拓寬你的困境的範圍以影響多個角色，或將特定玩家角色的故事編入遊戲的故事中。

成對的形象有兩種主要形式：連接兩個角色的形象，以及連接角色形象到一個議題。
...
對於一個劇折來說有一或兩個就足夠了，相信我們。

你在下面會看到，即使只有一個困境也能為兩或三次聚會創造足夠的材料。你不必覺得每個劇折都需要迎合到每個玩家，轉動聚光燈讓每個人都能獲得聚光燈時間，然後當你想專注於遊戲的較大的「情節」時，拋出與議題相關的劇折。
...
現在，你有個真正引人注目的困境，你可以更加充實局勢並精確地找出你的劇折旨在解決什麼，換句話說，在這個困境的核心上真正引人注目的問題是什麼？

這就是你在這個步驟要做的事：創建一系列你希望你的劇折要回答的問題。我們把這些稱為故事問題，因為這個故事在回答這些問題的過程中自然地浮現。

你有越多故事的問題，你的劇情段落就會越長。一至三個問題可能在一次遊戲聚會中總結。四至八個將會花掉你兩次甚至三次遊戲聚會。超過八或九個，你可能需要保留其中一些問題到之後的劇折，但這並不是件壞事。

我們建議你用是非題來詢問故事問題，在一般的格式，「（角色）可以／將會實現（目標）？」你不必確切遵循措辭，你可以以許多方式來潤飾基本問題的格式，我們會在之後展示給你看。

所有你提出的困境都將有一個非常明顯的故事問題：「玩家角色可以解決困境嗎？」你終究需要知道，但是你並不想直接跳到這，畢竟這是你的劇折的壓軸。把其他問題放在前面來為劇折添加細微差別和複雜性並且通往最後一個問題。弄清楚是什麼原因使得這個困境很難解決。

要想出故事問題，你很可能不得不對你想出的困境做點小潤飾，並找出六何的（何人，何物，何時，何地，為何，如何）細節。
...
請注意每個問題都有潛力顯著塑造劇折的情節。當下，如果瑟德決定不屈服認罪，那麼你就有了一個和他選擇屈服非常不同的局勢。如果瑟德的調查讓他被逮捕，那麼審判可能最終開啟一個爭端。如果辛納瑞決定幫助瑟德而不是去追逐寶石，那麼辛納瑞的雇主將成為他們另一個麻煩來源。

還要注意一些故事問題會修改基本的「甲可以完成乙嗎？」格式。你為什麼想這樣做的原因有些時候是跟你想避免擲骰的原因一樣，非黑即白的成功或是失敗總是不怎麼有趣，尤其是失敗。

看看給辛納瑞的問題之一：「辛納瑞是否能在珠寶的主要競爭對手發現她的身份前先發現對手的身份？」，沒有強調的部分，這樣是無聊的，如果她沒有發現對手的身份，那麼我們已經差不多跌出了情節線，而部分的遊戲也停止了。不好。

我們的方式是，雖然她在劇折的這部份沒有做好，我們仍會帶到某個地方，她可能不知道她的對手是誰，但她的對手現在知道她。無論是否還牽涉到珠寶，那對手可以在未來的劇折中回來困擾她。或者，我們把它當作辛納瑞最終要去揭露對手的身份，但我們仍然可以有一組衝突或競爭的緊張情勢引領到因為他們了解對方的能力而揭露真相。

還有一些空間可以將材料從現下的劇折延伸到未來。也許辛納瑞的對手的身份在這次劇折中完全沒有得到解答，因為它是個阿曼達隨時可以在以後的聚會中帶回的細節。

如果最終有大量的故事問題（如八個或更多），請記住，你不需要在一個劇折中回答所有問題，你可以將你無法回答的問題作為你之後的劇折的預示或設定來培養。事實上，這正是你該如何製作有力劇構的方式，你有一堆相關的故事問題且你需要兩到三個劇折來回答所有問題。

## 建立對抗者

當你完成你的麻煩時你可能已經想出了一個或一群的非玩家角色負責做什麼事，但如果你還沒有，你需要開始把那些解答你的故事問題的關鍵角色們湊在一起。你還需要敲定他們的動機和目標，他們為什麼反對玩家角色的目標，他們追求的是什麼。

最起碼，你應該要能夠為你的劇折中每個有名字的非玩家角色回答下面的問題：

- 這非玩角色需要什麼？玩家角色如何幫她得到，或者玩家角色如何擋到他的去路？
- 為什麼非玩家角色不能通過合法途徑得到他所需要的？ （換句話說，為什麼這個需求會導致麻煩？）
- 為什麼他不能被忽視？
只要可以，試著讓非玩家角色們合併，這樣你就不會要追蹤太多角色。如果你其中一個對抗的非玩家角色在你的劇折裡只有一個目的，考慮捨棄他並將他的職責混合到另一個非家角色中。這不僅降低了你的工作量，也可以讓你多開發一點每個非玩家角色的性格，讓你調和他全套的動機而使他更加多元化。

對於你的每一個非玩家角色，決定你要讓他們當輔助或主要角色。根據運行遊戲給出的指引製作他們的資料。
...
當你為你的劇折建立你的非玩家角色時，即使到了你要開始玩時也不必定好一切設定，你可以透過讓玩家創造的優勢成為非玩家角色的形象來幫助你建立。另請參閱後面文章來了解在遊戲中使用它的建議。

## 設立首個場景

事情開始的越明顯越好，拿出你一個故事問題，設法想出會讓問題更加突出並盡可能讓你的玩家們對此焦頭爛額的東西。你不必現在就回答（雖然回答了也沒有什麼不妥），但你應該向玩家展示出該問題需要答案。

這樣一來，你就為剩下的聚會設了一個範例並獲得勢頭，確保玩家不會優柔寡斷。請記住，他們應該要是積極主動且有能力的人，從一開始就給他們一些需要積極主動以及適合他們能力的事情。

如果你在一個進行中的戰役活動，你可能需要在聚會的首個場景去解決前一次聚會被留下未解決的事。花時間在那上面沒關係的，因為這有助於保持聚會之間的連續感。不過只要勢頭暫時平息，就用你的開幕場景又快又狠地歡迎他們。
...
That doesn’t mean she’s going to just toss the scene with Zird side—she’s just going to save it for a follow-up to the first scene.

忍者主持人的強力聚會開場招數

在你的首個場景開始時要求玩家貢獻出某些東西是幫助他們立即投入眼前發生的事的絕佳方式。如果你開場提示有任何彈性的東西，在你開始場景時要求你的玩家幫你填補空白。聰明的玩家會把它當作一個契機來嘗試使用強迫推動並立即獲得額外的命運點數，我們喜歡把這樣的玩法稱作「酷炫」。
...
當然，你也可以就讓你的劇折開場引子當成「預載」的強迫，並在聚會開始時以他們要立即處理的麻煩遞出一些命運點數給玩家角色。這有助於低重振的玩家了並可以立即發動命運點數的支出。確保你的團隊同意有給你全權授權講述他們進入的局勢，雖然，一些玩家會不喜歡失去控制。
...
所以，現在你應該準備好開始：你有了一個不能忽視的問題，各種各樣的故事問題將以數種方式引導解決該問題，一組核心非玩家角色和他們的動機，以及非常震撼的首個場景將讓一切更美味。

現在一切都應該是一帆風順，對不對？你提出問題，玩家們逐一回答，你的故事走向一個不錯又整潔的結論。

是啊...請相信我們，永遠不會發生這種事的。

要記住，當你真正開始劇折時最重要的是：無論發生什麼事情總是會與預期的不同。玩家角色會憎恨一個你打算讓他們交好的非玩家角色，因為瘋狂的成功而很早地送出一個壞人的秘密，遭受意外挫折而在過程中改變他們的行動進程，或者各式各樣就是與你所想的不同的事情。

請注意，我們不建議預先確定你的劇折將涉及哪些場景和地點，因為我們發現大多數時候面對有活力的玩家們與他們的選擇時，無論如何你都將會拋棄大部分的材料。

不過也並非全部都丟掉，你準備的這些東西在玩家做一些意想不到的事情時應能幫助你。你的故事問題夠含糊所以有多種方式來回答，你可以很快的削減掉不相關的並且臨機應變以別的東西代替，而無需拋棄你所作的其餘部分。
...
另外，了解你的非玩家角色的動機和目標比起只把他們擺在固定場景等待玩家角色來說，更可以讓你輕易地調整他們的行為。當玩家對你投出變化球，讓非玩家角色依他們的本性活躍與回應，在追求他們的目標的路上採取突然、令人驚訝的行動。
...
當你運行足夠場景能確切回答多數你準備劇折時所想出的故事問題時劇折結束。有時候，一場遊戲聚會中你就能作到，如果你有大量時間或是僅有少量問題。如果你有很多的問題，它可能會花你兩三次遊戲聚會來完成他們。

如果你讓事情有了一個令人滿意的結論，不必覺得有必要回答到每一個故事問題，你可以在未來的劇折中使用未解決的問題，如果他們無法吸引玩家也可以就此擱下他們。

一個劇折的結尾通常會觸發顯著的里程碑。發生這種情況時，你也應該會發現遊戲世界也需要擴展了。
