---
source: 命運核心版（Fate Core System 繁體中文翻譯）第 11 章〈額外事物〉，取自 faterpg 翻譯站 https://sites.google.com/site/faterpg/
...
命運中的額外事物是一個非常廣泛的術語。我們用它來形容任何在技術上是角色的一部分或者受角色的控制但得到特殊待遇的規則。如果你的命運遊戲是一部電影，這就是其中會用到特效預算之處。

額外事物的一些實例包括：

- 魔法和超自然力量
- 特殊裝置或設備，如在奇幻遊戲中的附魔武器和盔甲或是在科幻遊戲中的超科技
- 角色所擁有的載具
- 組織或者是由角色統治或對其有極大影響力的地點
在這裡的工具可以讓你量身定做以滿足你的遊戲或提供你剽竊的材料。沒關係。我們不介意。

我們將額外事物看作是角色表的擴展，所以無論誰控制著擁有額外事物的角色，那個人也對該額外事物有控制權。在大多數情況下會是玩家，但非玩家角色也可能有受遊戲主持人控制的額外事物。
...
在命運中，你可以把遊戲世界中任何事物看待成一個角色。如果你有需要，任何事物都可以擁有形象、技能、特技、壓力軌跡和後果。

我們稱之為青銅法則，但如果你留意網路也可能聽說過稱為命運碎形。我們已經在這本書的前段看到一些例子；你在創造過程中讓你的遊戲自身擁有形象，你在環境以及角色上放置局勢形象，而遊戲主持人可以讓環境危害有如擁有技能般做出攻擊。
...
武器值增加了成功命中時的檔次值。所以，如果你有武器：２，這意味著任何打擊都會比原來要高兩個檔次。這在平手時也算，因此當你使用武器，你在平手時造成壓力而不是得到一個推助。這讓武器更加危險。

護甲值降低了成功命中的檔次。因此，護甲：２讓任何打擊都會比原來低兩個檔次。如果你命中，但目標的護甲值降低檔次到零以下時，你會得到一個對你的目標使用的推助，但沒有造成任何傷害。

我們建議設定武器傷害的尺度從１到４，牢記在平手時，武器：４的命中將剔除四名一般無名非玩家角色。然後基於你認為你需要充分地保護每個級別的武器來設定你的護甲等級。
