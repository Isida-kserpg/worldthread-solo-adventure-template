...
如同在創造遊戲章節中所概述的，創造或決定設定往往是你和你的玩家之間的協作努力。在這個意義上，作為遊戲主持人在遊戲創造過程中你能做的最好的事情是開啟新思路並慷慨地分享自己的想法，就像其他人一樣。透過彼此提供建議擴大利基。如果他們覺得他們有參與建構遊戲，你的玩家會更加投入到遊戲中。
當然，如果每個人都願意接納，沒有什麼東西阻止你完整清晰的展現出打算運行什麼。「好吧，這將是一場關於在六零年代冷戰時期的遊戲，除了它有著蒸汽龐克和機甲。來吧！」如果你要這樣做，只要確保每個人都願意進入狀況。即使只有一個玩家沒進去而且也沒興趣進入，都會真正地影響遊戲。
**幻想與寫實**
說到在六零年代蘇聯的蒸汽龐克機甲，這是一個好主意來考量你想多「幻想」。核心概念的想法有很多樂趣，但如果他們太難與現實連結那麼你的玩家可能會在理解你所提出的遊戲上遇到麻煩。界線究竟在哪會隨著群組（以及玩家）有所不同，所以這裡沒有明確的答案。只要記得背離熟悉的設定時，不管是現實世界還是行之有效的風格約定，都有可能為你的玩家們帶來概念上的障礙。
讓每個人都有共同的理解並確保提前檢查任何疑問。
與此相反的做法是遊戲設定寫實，設定在現實世界，也許只有一或兩個明顯重大的偏離讓你們可以探索。溝通這樣的設置最簡單的方法就是將其指名一個你們都熟悉的時期和地點，再套上例外。例如，「這就像現代的倫敦，但機器人司空見慣的」或「這是第二次世界大戰之後的洛杉磯，但有些回國老兵具有超自然能力。」
**自上而下與自下而上**
遊戲的尺度範圍有多寬也很重要。有些人喜歡從全局開始深入到細節，而有些人則傾向於先專注眼前與現在再發展到全局。這些通常被分別稱為「自上而下」和「自下向上」。兩者之間沒有高低，各有其優點和缺點。
用自上而下的方法，你將提前確定一些設定中像誰是呼風喚雨的人，重要城市的地點，重要組織的性質等等。這具有清楚了解世界如何組成的優勢。例如，如果你已經決定塔魯阿王國正處於五大家族爭權狀態，那麼你立刻知道國家內值得注意的人很可能來自那些家族之一，如果不是，它將必須有個很好的理由。
當然，缺點就是除非你使用電影、電視節目、書籍、電子遊戲或任何預先存在的設定，否則通常需要大量的前置工作。這還需要玩家對這一切展現出非常透徹理解，它可能是艱鉅的。但是如果每個人都能理解，它可以創造非常愉快且好玩的遊戲。
不過如果你要自下而上，你會從對玩家有立即重要的東西開始。這可能是任何東西，從他們家鄉的一些著名非玩家角色到在隔壁工作的傢伙的名字。然後群體隨著故事理出細節。沒有必要知道東西如何融入這個世界，因為它會隨著每個人的想法發展自然融入。這世界自然從你開始之處展開。
潛在的缺點是它需要相當多的即興創作和臨時思考。這對於同桌的大家，遊戲主持人和玩家都是一樣。對遊戲主持人來說，這也許不是什麼大不了的，運行遊戲幾乎總是涉及一定程度的即興發揮，但不是所有玩家都準備好那種責任。此外，如果你的玩家喜歡沉浸在自己的角色，透過他們的眼睛來觀察遊戲世界，他們可能偶爾會從這個角度製造出一些不和諧，比方說他們為當場發現的魔法斧頭命名或者告訴你中情局的最後一個地下局長發生了什麼事。
雖然命運兩種方式都可以處理，但系統支援的是以玩家為主，用形象和故事細節的形式敘述的自下而上的方法。如果這剛好是你喜歡玩的方式，很好！如果不是，別有壓力，但偶爾可以嘗試看看。
**小規模與大規模**
在創造遊戲章節中已經有討論過一些關於遊戲規模的事，但它值得多一點的討論。
如該章提出來的，小規模的故事關注的事件與玩家角色們密切相連，並且可能有著非常有限的地理區域。大規模遊戲則是相反的：跨越國家，行星或星系的史詩遊戲，有著震撼世界的後果。這兩種類型的故事可以有很多樂趣，贏得銀河大帝的稱號和贏得與村中最漂亮的女孩牽手可以是同等的獎勵。然而，不要以為兩者是相互排斥的。
這裡有幾個方法來結合它們。
由小而大：這是典型的從零到成為英雄的故事，一個不起眼的人毫無準備地突然成就榮耀經歷了超出了他的經驗範圍的事件。想像星際大戰曙光乍現中的路克天行者。他開始只是一個小農民，駕駛Ｔ－１６競速和在托西星站惡作劇。然後，一對機器人進入他的生活和注入一點神秘感：誰是歐比王肯諾比？在他知道這一點之前，他與走私分子廝混，解救了公主，並為反抗軍打了驚人的一戰。這是一個從小規模開始擴大成一個大規模的故事的經典案例。
高峰和低谷：你在大規模中插入小規模，後者使用在這裡就像給予喘息一樣。通常情況下，大規模的故事情節將處理國家等級，行星的征服，被不可想像的超越眾生的玩意放逐，或是類似的問題，而小規模的故事情節本質上將更加個人，角色的生活幾乎與翻天覆地的事件沒有任何的關聯。例如，你可能會花一兩次遊戲聚會與大皇帝角力，然後更改焦點到角色重新與她的父親接觸或去幫助需要援手的朋友。小規模的遊戲聚會提供一些史詩行動之間喘息的事情，並給了玩家一個機會去深入他們的角色某些未開發的角落。另外，如果你要將小規模和大規模故事的路線連接起來，可以，而且玩家將會更加滿意。
**額外事物：你需要它們嗎？**
你是否需要設置類似超級能力，魔法，高科技道具，還是其他超凡範圍的東西？無論哪種，現在，在遊戲開始前你要釐清這一點。請參閱額外事物章節了解更多內容以及你可以如何在你的遊戲中利用它們。
...
`阿曼達說：「好的，那麼我們可以一次擲骰做完。我們這樣處理。你用運動擲骰對驚異（＋６）的對抗。如果你成功了，你穿過陷阱而不會受傷。如果你失敗了，你會被困在半途，必須再試一次，而我們也將像處理失敗的防禦擲骰一樣，你也會因為灼熱死亡什麼的承受打擊。」`
`莉莉有些畏懼，但仍點點頭拿起她的骰子。`
...
最後，一些行動在預設情況下應設定較低的難度，特別是如果沒有其他人來競爭或者對抗。在衝突中創造優勢若無人對抗，不應該比一般（＋１）或尚可（＋２）更難，同樣地試圖在物品或地點上放置形象也是一樣。請記住，對抗並不一定總是以非玩家角色的形式出現，如果邪惡主謀在他的辦公室藏匿證據以避開窺探，你可以當作是對抗的一種形式，即使主謀可能不是實際在那。
...
重要：交代你的選擇
你制定難度時的唯一限制是依循上面的白銀定律，你要確保你的選擇在你所創造的敘述中合理。我們不希望你過於瘋狂的模擬世界而將自己困在無用的牢籠中（「在格倫伍德村的鎖一般都有良好的品質，因為他們臨近一個富鐵礦」），也不要把這看作純粹的數字遊戲。如果把難度設在卓絕（＋５）的唯一原因是它比玩家角色的技能評等高出兩階，而你希望消耗他的命運點數，這樣會使你喪失信任。
在這個意義上，設定難度很像援引形象，都需要一個好理由支持你在故事中的選擇。即使這個理由是你臨時編造而不是預先寫好的，那也沒問題。
局勢形象是個很棒的工具，如果玩家已經知道他們所在的洞穴「十分黑暗」且「極其狹窄」，這就很容易交代為什麼他們潛匿通過隧道時難以保持安靜。沒有人會對你尋找著相關局勢並給每個對抗＋２感到訝異，因為它也反映了他們得到的援引獎勵。
無論哪種方式，不要跳過交代理由的部分：要麼在你告訴他們難度時立刻讓玩家知道，或是神秘地聳聳肩然後讓他們之後找出來（就像是用來編造理由的時間）。
你也可以嘗試使用『不合適』的難度來表明在遊戲中存在著未解的謎團，由於一些奇怪的原因，你嘗試闖入的馬廄門上有個史詩（＋７）難度的鎖。你不知道那裡為什麼如此重要？
或許你正嘗試完成著名的紫晶秩序學者們的初步測試，測試只是一個尚可（＋２）的學識擲骰。這是怎麼回事？他們對你特別好？你的任命是種政治需求嗎？是誰在操控？或只是因為秩序學者們的聲譽是假造的？
處理超群的成功
...
因此，有著極佳（＋４）體魄的角色能臥推多重？有著尚可（＋２）資源的角色在破產前能花費多少？
...
這也是無聊的。如果您認為尚可（＋２）資源可以買到兩百枚金幣或更少的任何東西，那麼你已經刪除了大量的潛在的張力和戲劇。轉眼間，每次有資源型的問題時，會變成取決於成本是否為兩百金幣，而不是任何場景關鍵。它也把一切都變成了一個簡單的合格或不合格的情況，這意味著你真的沒有一個很好的理由可以作技能擲骰。其次，這是不現實的，當人們花錢的時候，是誰能提供而不是金額多少的問題。
...
攻擊整個區域或是場景中的每個人是你將不得不依照情況來判斷的事，像任何其他技能使用的延伸（見前面第２０２頁）。根據你設置的情況，這可能是一件很普遍的事情（例如，因為每個人都使用手榴彈和炸藥），也或許是不可能的，又或者是需要一個特技。只要你能證明你不需要應用任何特殊的規則，你擲攻擊擲骰，而每個在區域中的人如常地防禦。根據具體情況，如果你也在攻擊的同一區域，你甚至可能要對自己的擲骰作防禦！
強迫與多個目標
...
因此，如果玩家角色是最高是極佳（＋４），你的主要非玩家角色大壞蛋應該有幾個驚異（＋６）列或一個頂端在驚異的金字塔。
