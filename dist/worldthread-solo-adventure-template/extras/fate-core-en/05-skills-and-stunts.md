...
Skills are rated on the adjective ladder. The higher the rating, the better your
...
We cover these in more detail in Actions and Outcomes, but here’s a quick reference so
...
you’ll do this as part of creating extras; see the Extras section for more details.
...
category of an action. The Challenges, Contests, and Conflicts section is full of different little rules about the circumstances
...
For more on creating your own skills, see the Extras section.
...
O**Overcome:** Athletics allows you to overcome any
...
C**Create an Advantage:** When you’re creating an
...
A**Attack:** Athletics is not meant as an attack skill.

D**Defend:** Athletics is a catch-all skill to roll for
...
O**Overcome**: As stated above, Burglary allows you to
...
C**Create an Advantage**: You can case a location with
...
A**Attack**: Burglary isn’t used for attacks.

D**Defend**: Same here. It’s not really a conflict
...
O**Overcome**: You use Contacts to overcome any
...
C**Create an Advantage**: Contacts allows you to
...
contacts tell me that Joe Steel is the Best Mechanic For A
Thousand Miles—we should talk to him.”)
...
fact, such as Known as a Mean Guy or
Notorious Swindler. Whether that person lives up to their
...
A**Attack**: Contacts isn’t used for attacks; it’s hard
to harm someone simply by knowing people.

D**Defend**: Contacts can be used to defend against
...
O**Overcome**: Crafts allows you to build, break, or
...
C**Create an Advantage**: You can use Crafts to
...
]Armor-Plated, Rugged Construction) or a
vulnerability for you to exploit (Flaw in the Cross-Beam,_
_Hasty Work).
...
A**Attack**: You probably won’t use Crafts to attack in
...
D**Defend**: As with attacking, Crafts doesn’t defend,
...
O**Overcome**: Use Deceive to bluff your way past
...
Like Crafts, how the Drive skill appears in
...
C**Create an Advantage**: You can use Drive to
...
A**Attack**: Drive isn’t usually used as an attack
...
D**Defend**: Avoiding damage to a vehicle in a physical
...
bearing. It’s basically the emotional Notice skill.

O**Overcome**: You don’t really use Empathy to overcome
...
C**Create an Advantage**: You can use Empathy to
...
A**Attack**: Empathy can’t really be used in this
capacity.

D**Defend**: This is the skill to go to in order to
...
counterpart, see Shoot.

O**Overcome**: Since you don’t really use Fight outside
...
C**Create an Advantage**: You’ll probably use Fight
for most of the advantages you create in a physical conflict. Any number of special moves can be covered with
...
A**Attack**: This is self-explanatory. You make
physical attacks with Fight. Remember, this is for close-in work, so you have
to be in the same zone as your opponent

D**Defend**: You use Fight to defend against any other
...
C**Create an Advantage**: Investigate is probably
...
A**Attack**: Investigate isn’t used to make attacks.
...
O**Overcome**: You can use Lore to overcome any
...
C**Create an Advantage**: Like Investigate, Lore
...
A**Attack**: Lore isn’t used in conflicts.
...
attacks and defenses. See the Extras
...
O**Overcome****: **You don’t really use Notice to
...
C**Create an Advantage**: You use Notice to create
...
use to your advantage in a situation, such as a convenient Escape
Route when you’re trying to get out of a building, or a
Subtle Weakness in the enemy’s line of defense. For
...
A**Attack**: Notice isn’t really used for attacks.

D**Defend**: You can use Notice to defend against any
...
A**Attack**: Physique is not used to harm people
directly—see the Fight skill for that.

D**Defend**: Though you don’t generally use Physique to
...
O**Overcome**: You can Provoke someone into doing what
...
C**Create an Advantage**: You can create advantages
representing momentary emotional states, like Enraged,
Shocked, or Hesitant. Your target
opposes with Will.

A**Attack**: You can make mental attacks with Provoke,
...
D**Defend**: Being good at provoking others doesn’t
...
O**Overcome**: Use Rapport to charm or inspire people
...
C**Create an Advantage**: Use Rapport to establish
...
Elevated Confidence, or stir a crowd into a Joyful Fervor,
or simply make someone Talkative or
Helpful.

A**Attack**: Rapport doesn’t cause harm, so you don’t
use it for attacks.

D**Defend**: Rapport defends against any skill used to
...
O**Overcome**: You can use Resources to get yourself
...
C**Create an Advantage**: You might use Resources
to grease the wheels and make people more friendly, whether that represents an
actual bribe (I Scratch Your Back_..._) or simply buying
drinks for people (In Vino Veritas). You can also use
...
The counterpart to Fight, Shoot is the skill
...
O**Overcome**: Unless, for some reason, you need to
...
C**Create an Advantage**: In physical conflicts,
...
Prone to Jams aspect on an opponent’s gun).

A**Attack**: This skill makes physical attacks. You can
make them from up to two zones away, unlike with Fight. (Sometimes the range
will change with the weapon.)

D**Defend**: Shoot is unique in that it doesn’t really
...
be represented by creating an advantage (Covering Fire or
...
trying to move about unseen. It pairs well with the Burglary skill.

O**Overcome**: You can use Stealth to get past any
...
C**Create an Advantage**: You’ll mainly use Stealth
to create aspects on yourself, setting yourself in an ideal position for an
attack or ambush in a conflict. That way, you can be Well-
Hidden when the guards pass by and take advantage of that, or
Hard to Pin Down if you’re fighting in the dark.

A**Attack**: Stealth isn’t used to make attacks.

D**Defend**: You can use this to foil Notice attempts
...
the same way that Physique represents
your physical fortitude.

O**Overcome**: You can use Will to pit yourself against
...
and Lore if it takes something more than
...
C**Create an Advantage**: You can use Will to place
