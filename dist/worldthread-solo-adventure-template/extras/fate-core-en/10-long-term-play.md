...
An arc is a complete storyline with
...
> For Zird, his Rivals in the Collegia Arcana makes it
...
In addition, you can also rename any moderate consequences you have, so that you can start them on the
...
I’ve Got Zird’s Back. I think I need to change that in
...
change the way you make opposition NPCs, because you’re going to
...
aspect Soul-Burned by the Demon Arc’yeth. She now has the
opportunity to rename that aspect again, and she decides to call it
I Must Kill Arc’yeth’s Kind—she hasn’t quite escaped the
...
Former Ivory Shroud Disciple, indicating his desire to
...
Secret Fealty to the Smuggler Queen to At War
with Barathar to represent the shifting power dynamic, as well as Lord
...
wide issue, Everybody Fears Hollister, so Amanda crosses
...
replaces the issue Seat of Barathar’s Power with a
different one, Smiles in the Open, Knives in the Dark to
...
Underworld Power Vacuum to reflect this.
...
things. She changes Saber-Rattling in the East to
The East at War!. That should give the PCs an interesting
decision to make.
